...
pub struct McAnnounceData {
    ...
    /// Time-to-live (ms) of flexicast packets.
    ...
    impl FlexicastPipe {
        ...
        pub fn setup_client(
            ...
            pipe.client
                ...
                .as_mut()
                .unwrap()
                .set_fc_path_id(pid_c2s_1 as u64);
        ...
        pub fn server_control_to_mc_source(
            ...
            for (pipe, ..) in self.unicast_pipes.iter_mut() {
                pipe.server.uc_to_fc_control(mc_channel, now)?;
            }
